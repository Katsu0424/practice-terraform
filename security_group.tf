...
resource "aws_security_group" "web_sg" {
  name        = "${var.project}-${var.environment}-web_sg-kamakari"
...
resource "aws_security_group" "app_sg" {
  name        = "${var.project}-${var.environment}-app_sg-kamakari"
  description = "application servr role security group"
  vpc_id      = aws_vpc.vpc.id
...
resource "aws_security_group" "opmng_sg" {
  name        = "${var.project}-${var.environment}-opmng_sg-kamakari"
...
resource "aws_security_group" "db_sg" {
  name        = "${var.project}-${var.environment}-db_sg-kamakari"
